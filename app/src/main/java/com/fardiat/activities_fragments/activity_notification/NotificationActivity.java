package com.fardiat.activities_fragments.activity_notification;
...
import com.fardiat.adapters.NotificationAdapter;
import com.fardiat.databinding.ActivityNotificationBinding;
...
import com.fardiat.models.NotificationModel;
    ...
    private void getNotification() {
        try {
            Api.getService(Tags.base_url)
                    .getNotification( userModel.getUser().getToken())
